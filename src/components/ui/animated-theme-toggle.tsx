...
function Button({ className, variant, disabled, onClick, children, "aria-label": ariaLabel, ...props }: {
  ...
  return (
    <button
      className={cn(
        "inline-flex items-center justify-center rounded-md border border-[var(--border)] bg-[var(--bg-secondary)] text-sm font-medium transition-colors hover:bg-[var(--tag-bg)] hover:text-[var(--text-primary)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
        className
      )}
      disabled={disabled}
      onClick={onClick}
